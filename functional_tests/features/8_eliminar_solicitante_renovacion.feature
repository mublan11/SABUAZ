Feature: Eliminacion de solicitante
	...
	Scenario: Eliminar de solicitante
		...
		Dado que yo puedo ver al estudiante "Veronica Rodriguez Tiscareño" y presiono el boton Eliminar
		y despues confirmo que lo quiero eliminar
		entonces puedo confirmar que el solicitante "Veronica Rodriguez Tiscareño" ya no existe la lista de registros de las becas
