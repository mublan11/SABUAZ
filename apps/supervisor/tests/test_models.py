...
class ModelsTest(TestCase):
    ...
    def test_get_absolute_url(self):
        self.assertEqual('/supervisor/', f'/supervisor/')
    ...
    def test_string_representation_domicilio_model(self):
        self.assertEqual(
            str(self.domicilio),
            'Preparatoria 311 Centro 98000 Zacatecas Zacatecas')

    def test_string_representation_domicilio_casa_model(self):
        self.assertEqual(
            str(self.domicilio_casa),
            'Preparatoria 311 Centro 98000 Zacatecas Zacatecas')

    def test_string_representation_telefono_model(self):
        self.assertEqual(str(self.telefono), '4921001212')

    def test_string_representation_telefono_casa_model(self):
        self.assertEqual(str(self.telefono_casa), '4921011112')

    def test_string_representation_supervisor_model(self):
        self.assertEqual(str(self.supervisor), ' Rodriguez Aguayo')
